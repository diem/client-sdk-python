import pytest
from calibra.lib.clients.pylibra2 import LibraUserIdentifier
...
def test_encode_addr_success():
    ...
    enocded_addr = LibraUserIdentifier.encode(
