...
def metadata_call_credentials(
    metadata_plugin: AuthMetadataPlugin, name: typing.Optional[str] = None,
) -> CallCredentials: ...
...
def method_handlers_generic_handler(
    service: str, method_handlers: typing.Dict[str, RpcMethodHandler],
) -> GenericRpcHandler: ...
...
class Channel:
    ...
    def subscribe(
        self, callback: typing.Callable[[ChannelConnectivity], None], try_to_connect: bool = False,
    ) -> None: ...
    def unary_stream(
        self,
        method: str,
...
class RpcMethodHandler(typing.Generic[TRequest, TResponse]):
    ...
    stream_stream: typing.Optional[
        typing.Callable[[typing.Iterable[TRequest], ServicerContext], typing.Iterable[TResponse]]
    ]
