...
from pylibra2 import serde_types as st
from pylibra2 import serde_binary as sb
...
def deserialize(content: bytes, obj_type) -> typing.Tuple[typing.Any, bytes]:
    return sb.deserialize_with_config(copy(_lcs_deserialization_config), content, obj_type)
