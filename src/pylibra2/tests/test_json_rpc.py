        ...
        "result": [
            {
                ...
                "vm_status": {"type": "executed"},
                "gas_used": 0,
                "hash": "500a9002995e1af93bbdaf977385ed507b174bb3dc6936efd72612d56198a19a",
                "bytes": "",
            },
            {
                ...
                "vm_status": {"type": "executed"},
                "gas_used": 0,
                "hash": "500a9002995e1af93bbdaf977385ed507b174bb3dc6936efd72612d56198a19b",
                "bytes": "",
            },
        ],
    }
...
def test_account_state_response_success(mock_session):
    ...
    assert response_obj.responses[0] == AccountStateResponse(
        address="11" * 16,
        balances=[Amount(amount=100000000000, currency="LBR")],
        sequence_number=0,
        authentication_key="2ee7110c881f5e62d168fb8e757fead0e0372b4f465415dcc4c103d66f237ecb",
        sent_events_key="0100000000000000e0372b4f465415dcc4c103d66f237ecb",
        received_events_key="0000000000000000e0372b4f465415dcc4c103d66f237ecb",
...
def test_get_account_transaction_with_events_success(mock_session):
    ...
    assert response_obj.responses[0] == Transaction(
        transaction=UserTransactionData(
            ...
            max_gas_amount=1000000,
            public_key="500a9002995e1af93bbdaf977385ed507b174bb3dc6936efd72612d56198a19d",
            script=PeerToPeerTransactionScript(
                amount=10000000,
                currency="LBR",
                metadata="",
                metadata_signature="",
        ...
        events=[
            Event(
                ...
                sequence_number=0,
                transaction_version=4433485,
                data=SentPaymentEventData(
                    amount=Amount(amount=10000000, currency="LBR"),
                    metadata="",
                    sender="c1fda0ec67c1b87bfb9e883e2080e530",
                    receiver="4ac94d88e90acd4cf0294e898e421e94",
                    type="sentpayment",
...
def test_writeset_unknown_tx_success(mock_session):
    ...
    assert response_obj.responses[0] == [
        Transaction(
            transaction=WriteSetTransactionData(type="writeset"),
            events=[],
            version=4433485,
            vm_status=ExecutedVMStatus(),
            gas_used=0,
        ...
        Transaction(
            transaction=UnknownTransactionData(type="unknown"),
            events=[],
            version=4433485,
            vm_status=ExecutedVMStatus(),
            gas_used=0,
